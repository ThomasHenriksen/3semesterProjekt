...
namespace ArmysalgService.ModelConversion
{
    public class SalesOrderdataReadDtoConvert
    {
        ...
        {
            SalesOrderdataReadDto foundSales = new SalesOrderdataReadDto(inSalesOrder.SalesNo, inSalesOrder.SalesDate, inSalesOrder.PaymentAmount, inSalesOrder.Status.ToString(), inSalesOrder.SalesLineItem);
            return foundSales;
        }
        ...
        public static SalesOrderdataReadDto FromSalesOrder(SalesOrder inSalesOrder)
        {
                ...
                {
                    aSalesOrderReadDto = new SalesOrderdataReadDto(inSalesOrder.SalesNo, inSalesOrder.SalesDate, inSalesOrder.PaymentAmount, inSalesOrder.Status.ToString(), inSalesOrder.SalesLineItem);
                }
